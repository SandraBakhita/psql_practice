INSERT INTO Department (Num_S,Labels, Manager_Name) VALUES
(1,'IT','Alice Johnson'),
(2,'HR','Bob Smith'),
(3,'Marketing','Clara Bennett');

INSERT INTO Employees (Num_E,Name,Position,Salary, Department_Num_S) VALUES
...
INSERT INTO Projects (Num_P, Title, Start_Date, End_Date, Department_Num_S) VALUES
(201,'Website Redesign','2024-01-15','2024-06-30',1),
(202, 'Employee Onboarding','2024-03-01','2024-09-01', 2),
(203, 'Market Research', '2024-02-02','2024-07-31', 3),
...
SET Roles = 'Full Stack Developer'
